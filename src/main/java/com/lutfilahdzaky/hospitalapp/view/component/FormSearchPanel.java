...
import com.lutfilahdzaky.hospitalapp.system.*;
...
public class FormSearchPanel extends JPanel {
    ...
    private void init() {
        ...
        textSearch.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON, new FlatSVGIcon("com/lutfilahdzaky/hospitalapp/icons/search.svg", 0.4f));
    ...
    private void showRecentResult() {
        String[] recentSearch = AppPreferences.getRecentSearch(false);
        String[] favoriteSearch = AppPreferences.getRecentSearch(true);
        panelResult.removeAll();
        listItems.clear();
    ...
    private class Item extends JButton {
        ...
        protected Component createRecentOption() {
            ...
            if (!isFavorite) {
                ...
                JLabel label = new JLabel(new SVGIconUIColor("com/lutfilahdzaky/hospitalapp/icons/favorite_filled.svg", 0.4f, "Component.accentColor", 0.8f));
                label.putClientProperty(FlatClientProperties.STYLE, "" +
                        "border:3,3,3,3;");
                panel.add(label);
            }
        ...
        private JButton createButton(String name, String icon, float scale, String hoverKey, float alpha) {
            SVGIconUIColor svgIcon = new SVGIconUIColor("com/lutfilahdzaky/hospitalapp/icons/" + icon, scale, "Label.disabledForeground", alpha);
